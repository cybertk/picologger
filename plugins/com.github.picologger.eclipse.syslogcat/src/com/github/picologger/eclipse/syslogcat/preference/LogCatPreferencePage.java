...
package com.github.picologger.eclipse.syslogcat.preference;
...
import com.github.picologger.eclipse.syslogcat.views.LogCatView;
...
public class LogCatPreferencePage extends FieldEditorPreferencePage implements
    ...
    public LogCatPreferencePage() {
        super(GRID);
        setPreferenceStore(SyslogPlugin.getDefault().getPreferenceStore());
    }
