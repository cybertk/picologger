 ...
 * {@link #setLogOutput(com.android.ddmlib.Log.ILogOutput)} to redirect the log
 * somewhere else.
 */
public final class Log {
    ...
    public enum LogLevel {
         ...
         * 
         * @param letter
         *            the letter matching a <code>LogLevel</code> enum
         * @return a <code>LogLevel</code> object or <code>null</code> if no
         *         match were found.
         */
         ...
         * Returns the {@link LogLevel} enum matching the specified letter.
         * <p/>
         * The letter is passed as a {@link String} argument, but only the first
         * character is used.
         * 
         * @param letter
         *            the letter matching a <code>LogLevel</code> enum
    ...
    /**
     * Classes which implement this interface provides methods that deal with
     * outputting log
     * messages.
     */
    public interface ILogOutput {
        ...
        /**
         * Sent when a log message needs to be printed, and, if possible,
     ...
     *            The message to output.
     */
    public static void logAndDisplay(LogLevel logLevel, String tag,
            String message) {
    ...
    /**
     * Sets the {@link ILogOutput} to use to print the logs. If not set,
     * {@link System#out} will be used.
     * 
     * @param logOutput
     *            The {@link ILogOutput} to use to print the log.
     */
     ...
     * Show hex dump.
     * <p/>
     * Local addition. Output looks like: 1230- 00 11 22 33 44 55 66 77 88 99 aa
     * bb cc dd ee ff 0123456789abcdef
     * <p/>
     * Uses no string concatenation; creates one String object per line.
     */
    static void hexDump(String tag, LogLevel level, byte[] data, int offset,
            int length) {
